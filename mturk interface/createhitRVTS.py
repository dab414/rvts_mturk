## Tim's code, will need to update for boto3
...
ACCESS_ID = 'AKIAJUG6HFQWG4DVP6TA'
SECRET_KEY = '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'
...
def PostHits():
  ...
  q = ExternalQuestion(external_url = "https://www.dropbox.com/s/qyw3yctu8ev3qpb/rvts_main.html?dl=0", frame_height=675)
