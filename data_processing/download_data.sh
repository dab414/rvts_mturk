...
## ^ back when i was on windows LOL

download public_html/turk/data/rvtsSwitchExperiments/* /home/dave/OneDrive/Research/By\ Project/mturk/rvts/subject_data/pilot_data/
